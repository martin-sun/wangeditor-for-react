...
class ReactWEditor extends React.PureComponent {
  constructor(..._args) {
    ...
    _defineProperty(this, "id", (0, _uniqueId.default)(8));
    _defineProperty(this, "hasCreated", false);
    // 是否执行 create 创建函数
    _defineProperty(this, "imgFile", new _imgFile.default());
    _defineProperty(this, "defaultConfig", {
      zIndex: 1
    });
    _defineProperty(this, "editor", null);
    _defineProperty(this, "_isMounted", false);
    _defineProperty(this, "__hook__run", (hooks = [], args = [], target) => {
     ...
     * 根据属性，配置默认设置
     */
    _defineProperty(this, "setDefaultConfigByProps", () => {
      const {
        placeholder,
        onChange,
        onFocus,
    ...
    _defineProperty(this, "changeCreatedFlag", flag => this.hasCreated = flag);
    _defineProperty(this, "created", () => this.changeCreatedFlag(true));
    _defineProperty(this, "destroyed", () => this.changeCreatedFlag(false));
    _defineProperty(this, "isCreated", () => this.hasCreated === true);
  }
